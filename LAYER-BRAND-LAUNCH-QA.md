...
| Git commits | `4b5d3659be728b63fc2f6119b2c3c3dfca02e525` introduced the brand assets and metadata; `b9985019e6094c7dba081d4efa4909fd70ac16bd` added the visible header byline. |
...
| Production domain | `https://layerbylaya.com` first served the brand build through Ready deployment `7tZ9VJnY43kdyveCWwg8hFCuQk71`; later commits retain these assets and metadata. |
...
The header combines the official LayeR wordmark with a visible “by Laya” label. Its layout was checked locally at desktop width and at 390 × 844 mobile width, with the menu still accessible. Commit `b998501` was Ready as a Vercel preview (`5pYMVVNhiFyYCp2RCmi1HwSHoJYA`) and as a production deployment (`6P81gr88KgpCRLPej7fmW8ED6YL2`); the preview showed the visible byline and retained the branded Open Graph image.
